    ...
    try:
        ...
        try:
            ...
            if not b2b_token or not b2b_cookie:
                ...
                response = requests.post(b2b_1688_url, data=form_data, headers=b2b_1688_headers, timeout=25, verify=False, proxies={'http': None, 'https': None})
            ...
            if b2b_token and b2b_cookie:
                ...
                response = requests.post(b2b_taobao_url, data=form_data, headers=b2b_taobao_headers, timeout=25, verify=False, proxies={'http': None, 'https': None})
        ...
        try:
            ...
            if not d2c_cookie:
                ...
                response = requests.post(d2c_1688_url, data=form_data, headers=d2c_1688_headers, timeout=25, verify=False, proxies={'http': None, 'https': None})
