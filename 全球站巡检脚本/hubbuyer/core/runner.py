...
class ScriptRunner:
    ...
    def run(script_relative_path, project_root, task_config):
        ...
        try:
            ...
            runner_timeout = task_config.get("runner_timeout") or SCRIPT_RUNNER_TIMEOUT
            ...
            if process.returncode == 0 and stdout_data:
                try:
                    ...
                    response["sub_results"] = parsed_data.get("sub_results") or {}
            ...
            response["message"] = f"执行超时({runner_timeout}s)"
