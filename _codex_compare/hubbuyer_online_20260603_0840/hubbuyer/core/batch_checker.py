...
class BatchChecker:
    ...
    def run_all_checks(self):
        ...
        priority = ["web_rules.json", "login_rules.json", "exchange_rate.json", "img_search.json","add_cart.json","B2B_Addon.json","D2C_Addon.json","submit_order.json","payment.json"]
