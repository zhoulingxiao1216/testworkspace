...
AUTH_TOKEN = "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpc3MiOiJodHRwczpcL1wvc2FrdXJhZGsyLmNvbSIsImlhdCI6MTc3ODAzNDIyNSwiZGF0YSI6eyJpZCI6ODE2MCwibmFtZSI6Ilx1NmU1Nlx1NWM3MVx1NzljMFx1NzUzNyIsIm1haWwiOiJrb3lhbWFAbi1hdmkuY28uanAifSwic2NvcGVzIjoicm9sZV9hY2Nlc3MiLCJleHAiOjE3NzkzMzAyMjV9.meVb0ugqXw5aoUmLJttRixeKwmtGIeisi4hZpHG4GEQ"
...
COOKIES = {
    "PHPSESSID": "4opuoksd4rd8ltnj5rjqvajp55",
    "login_token": AUTH_TOKEN,
    "server_login_token": AUTH_TOKEN,
    "login_user_id": "8160"
}

OUT_DIR = r"d:\test_workspace\8160_模板核对\sticker_images"
...
def fetch_tag_info(item_id):
    url = f"{BASE_URL}/api_user/Pic_Newspaper/getOrderTag"
...
def main():
    ...
    # 保存映射
    with open(r"d:\test_workspace\8160_模板核对\sticker_mapping.json", "w", encoding="utf-8") as f:
        json.dump(mapping, f, ensure_ascii=False, indent=2)

    ok_count = len([m for m in mapping if m.get("local_img")])
    print(f"\n完成! 已下载 {ok_count}/{len(products)} 张吊牌图片")
    print(f"映射表: d:\\test_workspace\\8160_模板核对\\sticker_mapping.json")
